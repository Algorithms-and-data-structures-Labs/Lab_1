...
TEST(Polinom, Correct_adding_operator) {
  ...
  EXPECT_EQ(pol3.ToString(),
            "4x^5y^6z^7 + 6x^4y^5z^6 + 4x^3y^4z^5 + 2x^2y^3z^4");
}

TEST(Polinom, Correct_polinom_enter) {
  vector<int> a = {1, 234, 2, 345, 4, 567, 3, 456};
  TPolinom pol(a);
  EXPECT_EQ(pol.ToString(),
            "4x^5y^6z^7 + 3x^4y^5z^6 + 2x^3y^4z^5 + 1x^2y^3z^4");
}
...
TEST(Polinom, Adding_Monom) {
  ...
  pol.AddMonom(mon);
  EXPECT_EQ(pol.ToString(),
            "4x^5y^6z^7 + 3x^4y^5z^6 + 2x^3y^4z^5 + 1x^2y^3z^5 + 1x^2y^3z^4");
}
TEST(Polinom, Mult) {
  vector<int> a = {1, 234, 2, 345, 4, 567, 3, 456};
  TPolinom pol(a);
  ...
  pol3 = pol * 2;
  EXPECT_EQ(pol.ToString(),
            "8x^5y^6z^7 + 6x^4y^5z^6 + 4x^3y^4z^5 + 2x^2y^3z^4");
}
